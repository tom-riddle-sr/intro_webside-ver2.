...
const Stroke = () => {
  return (
    <div>
      {/* <svg className={clsx(styles.stroke, styles.ani)} height="400" width="100%" fill='none' stroke='black' strokeWidth={5} >
        <g>
      ...
      <svg className={clsx(styles.stroke, styles.ani)} version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1500 1000" width="6000" height="2000">
        <defs>
